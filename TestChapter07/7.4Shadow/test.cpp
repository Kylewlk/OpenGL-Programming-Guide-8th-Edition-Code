...
void init()
{
    ...
    {
        { GL_VERTEX_SHADER, "7.4Shadow_light.vert" },
        { GL_FRAGMENT_SHADER, "7.4Shadow_light.frag" },
        { GL_NONE,"" }
    };
 ...
 //   //glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, DEPTH_TEX_SIZE, DEPTH_TEX_SIZE, 0, GL_RGBA, GL_BYTE, NULL);
	//glTexStorage2D(GL_TEXTURE_2D, 0, GL_RGBA8, DEPTH_TEX_SIZE, DEPTH_TEX_SIZE);
	//glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, DEPTH_TEX_SIZE, DEPTH_TEX_SIZE, GL_RGBA, GL_FLOAT, NULL);
 //   glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
 //   glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
 //   glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
 //   glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
